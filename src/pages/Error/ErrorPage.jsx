        ...
        <div className="w-full ">
          <div className="flex flex-col items-center max-w-lg mx-auto text-center">
            ...
            <div className="flex items-center max-w-5xl mt-6 gap-x-3 mx-auto ">
              <Link to="/">
                <button className="w-full px-5 py-2 text-sm tracking-wide text-white transition-colors duration-200 bg-blue-500 rounded-lg shrink-0  hover:bg-blue-600 dark:hover:bg-blue-500 dark:bg-blue-600">
                  Take me home
                </button>
              </Link>
            </div>
